/* Chriate – Mas Item #227 - Search Popup (11/09/23) - START */
jQuery(document).ready(function () {
  const visitedProducts =
    JSON.parse(localStorage.getItem("visited_products")) || [];

  const observer227 = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      if (
        mutation.type === "attributes" &&
        mutation.attributeName === "class"
      ) {
        if (document.body.classList.contains("test_227")) {
          test_227();
          ...
          observer227.disconnect();
        }
      }
    });
  });

  observer227.observe(document.body, {
    attributes: true,
  });
...
function test_227() {
  ...
  if (window.innerWidth >= 1025) {
    ...
    jQuery('.header__search-form input[type="search"]').on(
      "focus",
      function () {
        jQuery(".search-popup").addClass("show");
      },
    );
...
/* Chriate – Mas Item #227 - Search Popup (11/09/23) - END */