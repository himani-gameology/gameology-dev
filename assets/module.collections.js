    ...
    theme.Collections = function() {
        ...
        Collections.prototype = $.extend({}, Collections.prototype, {
            _parseURL: function() {
                ...
                var obj = {
                    ...
                    params: {
                        ...
                        // Chriate – Mas Item #196 - Available Products (23/01/23) - START
                        only_preorder_enable: null,
                        // Chriate – Mas Item #196 - Available Products (23/01/23) - END
                    ...
                    if(key === 'constraint') {
                        ...
                        $.each(value.split('+'), function (i, v) {
                            ...
                            // Chriate – Mas Item #196 - Available Products (23/01/23) - START
                                ...
                                obj.params.only_preorder_enable = value === 'true' ? true : value === 'false' ? false : null;
                            // Chriate – Mas Item #196 - Available Products (23/01/23) - END
                            } else if(key === 'lo') {
            ...
            _buildURL: function(obj) {
                ...
                // Chriate – Mas Item #196 - Available Products (23/01/23) - START
                if(window.page.default.only_available === true || window.page.default.logic_or === true || obj.params.vendors.length || obj.params.types.length || obj.params.options.length || obj.params.title !== null || obj.params.price_from !== null || obj.params.price_to !== null || obj.params.only_available_enable != null || obj.params.only_preorder_enable != null || obj.params.logic_or_enable != null) {
                // Chriate – Mas Item #196 - Available Products (23/01/23) - END
                    params[0] = [];
                    ...
                    // Chriate – Mas Item #196 - Available Products (23/01/23) - START
                    if(obj.params.only_preorder_enable !== null && obj.params.only_preorder_enable !== window.page.default.only_available) {
                        params[0].push('po_:' + obj.params.only_preorder_enable);
                    }
                    // Chriate – Mas Item #196 - Available Products (23/01/23) - END
            ...
            _setControls: function(obj) {
                ...
                var only_available_enable = window.page.default.only_available,
                    ...
                    only_preorder_enable = window.page.default.only_available;

                if(obj.params.only_available_enable !== null) {
                    only_available_enable = obj.params.only_available_enable;
                }

                if(obj.params.only_preorder_enable !== null) {
                    only_preorder_enable = obj.params.only_preorder_enable;
                }
                // Chriate – Mas Item #196 - Available Products (23/01/23) - END
                ...
                // Chriate – Mas Item #196 - Available Products (23/01/23) - START
                $('[name="only_preorder"]').prop('checked', only_preorder_enable ? 'checked' : false);
                // Chriate – Mas Item #196 - Available Products (23/01/23) - END
            ...
            load: function() {
                ...
                this.dom.$sidebar.on('change', '[name="filter_by_tag_98"]', function () {
                    var obj = _._parseURL(),
                        new_obj = $.extend(true, {}, obj),
                        $this = $(this),
                        val = $this.val();
                    ...
                    if($this.hasClass('input-player-checked')) {
                        $this.removeClass('input-player-checked');
                        $('.js-collection-banner-journey').removeAttr('data-filter');
                        new_obj = _._changeObj(new_obj, 'params.tags', 'remove', val);
                    } else {
                        var bannerVal = $this.attr('data-banner');

                        console.log(bannerVal);

                        if($('.input-player-checked').length > 0) {
                            var resetVal = $('.input-player-checked').val();
                            new_obj = _._changeObj(new_obj, 'params.tags', 'remove', resetVal);
                            $('.input-player-checked').removeClass('input-player-checked');
                        }

                        $this.addClass('input-player-checked');
                        $('.js-collection-banner-journey').attr('data-filter', bannerVal);
                        new_obj = _._changeObj(new_obj, 'params.tags', 'add', val);
                    }
                ...
                this.dom.$sidebar.on('change', '[name="filter_by_type"]', function () {
                    ...
                    $('.filter-type-trigger[data-value="'+val+'"]').toggleClass('active');
                ...
                $('.js-clear-all-type').on('click', function () {
                    ...
                    $('.filter-type-trigger').removeClass('active');
                ...
                // Chriate – Mas Item #196 - Available Products (23/01/23) - START
                this.dom.$sidebar.on('change', '[name="only_preorder"]', function () {
                    var obj = _._parseURL(),
                        new_obj = $.extend(true, {}, obj),
                        $this = $(this);

                    new_obj = _._changeObj(new_obj, 'params.page', 'change', null);
                    new_obj = _._changeObj(new_obj, 'params.only_preorder_enable', 'change', $this.is(':checked'));
                    console.log('change');
