    ...
    theme.StickySidebar = function() {
        ...
        StickySidebar.prototype = $.extend({}, StickySidebar.prototype, {
            ...
            update: function (action, scroll) {
                ...
                var _ = this,
                    header_offset_top = theme.StickyHeader && theme.StickyHeader.$sticky ? Math.ceil(theme.StickyHeader.$sticky.stickyHeader('getStickyHeight')) : 0,
                ...
                $.each(this.sidebars, function (i, sidebar) {
                    ...
                    if((body_pos.height + _.settings.min_height_diff >= parent_pos.height) || (sidebar.$elem.hasClass('sticky-sidebar-xl') && theme.current.bp !== 'xl')) {
                        //off
